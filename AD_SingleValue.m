...
function DAQ_Outputs(block)
    ...
    prmDevice = block.InputPort(1).Data;
    prmChannel = block.InputPort(2).Data;
    prmOversampling = block.InputPort(3).Data;
    prmGain = block.InputPort(4).Data;
    prmPolarity = block.InputPort(5).Data;
